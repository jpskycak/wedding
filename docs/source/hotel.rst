...
* We have two hotel blocks: one in `Elkhart <https://bit.ly/elkhart-hotel>`_ next to the venue and another in `Mishawaka <bit.ly/mishawaka-hotel>`_, which is about a 20 minute drive to the venue.
\
